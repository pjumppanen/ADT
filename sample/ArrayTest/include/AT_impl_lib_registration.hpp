static const R_CallMethodDef extMethods[] = 
{
  ...
  {"_AT.create", (DL_FUNC)&AT_create, 13},
  ...
  {"_AT.get.A2_B", (DL_FUNC)&AT_get_A2_B, 2},
  {"_AT.set.A2_B", (DL_FUNC)&AT_set_A2_B, 3},
  {"_AT.get.nt.A2_B", (DL_FUNC)&AT_get_nt_A2_B, 2},
  {"_AT.set.nt.A2_B", (DL_FUNC)&AT_set_nt_A2_B, 3},
  {"_AT.get.A2_C", (DL_FUNC)&AT_get_A2_C, 2},
  {"_AT.set.A2_C", (DL_FUNC)&AT_set_A2_C, 3},
  {"_AT.get.nt.A2_C", (DL_FUNC)&AT_get_nt_A2_C, 2},
  {"_AT.set.nt.A2_C", (DL_FUNC)&AT_set_nt_A2_C, 3},
  {"_AT.get.A2_DA", (DL_FUNC)&AT_get_A2_DA, 2},
  {"_AT.set.A2_DA", (DL_FUNC)&AT_set_A2_DA, 3},
  {"_AT.get.nt.A2_DA", (DL_FUNC)&AT_get_nt_A2_DA, 2},
  {"_AT.set.nt.A2_DA", (DL_FUNC)&AT_set_nt_A2_DA, 3},
  ...
  {"_AT.get.A2_LB", (DL_FUNC)&AT_get_A2_LB, 2},
  {"_AT.set.A2_LB", (DL_FUNC)&AT_set_A2_LB, 3},
  {"_AT.get.nt.A2_LB", (DL_FUNC)&AT_get_nt_A2_LB, 2},
  {"_AT.set.nt.A2_LB", (DL_FUNC)&AT_set_nt_A2_LB, 3},
  {"_AT.get.A2_UC", (DL_FUNC)&AT_get_A2_UC, 2},
  {"_AT.set.A2_UC", (DL_FUNC)&AT_set_A2_UC, 3},
  {"_AT.get.nt.A2_UC", (DL_FUNC)&AT_get_nt_A2_UC, 2},
  {"_AT.set.nt.A2_UC", (DL_FUNC)&AT_set_nt_A2_UC, 3},
  ...
  {"_AT.isNegative", (DL_FUNC)&AT_R_isNegative, 2},
  {"_AT.nt.isNegative", (DL_FUNC)&AT_R_nt_isNegative, 2},
  {"_AT.isPositive", (DL_FUNC)&AT_R_isPositive, 2},
  {"_AT.nt.isPositive", (DL_FUNC)&AT_R_nt_isPositive, 2},
  {"_AT.get.ix", (DL_FUNC)&AT_get_ix, 1},
  {"_AT.set.ix", (DL_FUNC)&AT_set_ix, 2},
  {"_AT.get.iy", (DL_FUNC)&AT_get_iy, 1},
  {"_AT.set.iy", (DL_FUNC)&AT_set_iy, 2},
  {"_AT.polySum3D", (DL_FUNC)&AT_R_polySum3D, 2},
  {"_AT.nt.polySum3D", (DL_FUNC)&AT_R_nt_polySum3D, 2},
  {"_AT.POLYSUM3D_BX", (DL_FUNC)&AT_R_POLYSUM3D_BX, 4},
  {"_AT.nt.POLYSUM3D_BX", (DL_FUNC)&AT_R_nt_POLYSUM3D_BX, 4},
  ...
  {"_AT.get.SingularBool", (DL_FUNC)&AT_get_SingularBool, 1},
  {"_AT.set.SingularBool", (DL_FUNC)&AT_set_SingularBool, 2},
  {"_AT.get.SingularLongbool", (DL_FUNC)&AT_get_SingularLongbool, 1},
  {"_AT.set.SingularLongbool", (DL_FUNC)&AT_set_SingularLongbool, 2},
  ...
  {"_AT.get.female", (DL_FUNC)&AT_get_female, 0},
  {"_AT.get.male", (DL_FUNC)&AT_get_male, 0},
  {"_AT.get.n_sex", (DL_FUNC)&AT_get_n_sex, 0},
  0
};
