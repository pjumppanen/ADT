...
"  CALL POPCONTROL4BARRAY(V,SIZE)\n"
"END\n"
"CALL_EXPAND PUSHREAL4_B(V,VD)\n"
"  CALL PUSHREAL4(V)\n"
"  CALL PUSHREAL4(VD)\n"
"END\n"
"\n"
"CALL_EXPAND POPREAL4_B(V,VD)\n"
"  CALL POPREAL4(VD)\n"
"  CALL POPREAL4(V)\n"
"END\n"
"\n"
"CALL_EXPAND LOOKREAL4_B(V,VD)\n"
"  CONTINUE\n"
"END\n"
"\n"
"CALL_EXPAND PUSHREAL4ARRAY_B(V,VD,SIZE)\n"
"  CALL PUSHREAL4ARRAY(V,SIZE)\n"
"  CALL PUSHREAL4ARRAY(VD,SIZE)\n"
"END\n"
"\n"
"CALL_EXPAND POPREAL4ARRAY_B(V,VD,SIZE)\n"
"  CALL POPREAL4ARRAY(VD,SIZE)\n"
"  CALL POPREAL4ARRAY(V,SIZE)\n"
"END\n"
"\n"
"CALL_EXPAND PUSHREAL8_B(V,VD)\n"
"  CALL PUSHREAL8(V)\n"
"  CALL PUSHREAL8(VD)\n"
"END\n"
"\n"
"CALL_EXPAND POPREAL8_B(V,VD)\n"
"  CALL POPREAL8(VD)\n"
"  CALL POPREAL8(V)\n"
"END\n"
"\n"
"CALL_EXPAND LOOKREAL8_B(V,VD)\n"
"  CONTINUE\n"
"END\n"
"\n"
"CALL_EXPAND PUSHREAL8ARRAY_B(V,VD,SIZE)\n"
"  CALL PUSHREAL8ARRAY(V,SIZE)\n"
"  CALL PUSHREAL8ARRAY(VD,SIZE)\n"
"END\n"
"\n"
"CALL_EXPAND POPREAL8ARRAY_B(V,VD,SIZE)\n"
"  CALL POPREAL8ARRAY(VD,SIZE)\n"
"  CALL POPREAL8ARRAY(V,SIZE)\n"
"END\n"
"\n"
"CALL_EXPAND PUSHREAL16_B(V,VD)\n"
"  CALL PUSHREAL16(V)\n"
"  CALL PUSHREAL16(VD)\n"
"END\n"
"\n"
"CALL_EXPAND POPREAL16_B(V,VD)\n"
"  CALL POPREAL16(VD)\n"
"  CALL POPREAL16(V)\n"
"END\n"
"\n"
"CALL_EXPAND LOOKREAL16_B(V,VD)\n"
"  CONTINUE\n"
"END\n"
"\n"
"CALL_EXPAND PUSHREAL16ARRAY_B(V,VD,SIZE)\n"
"  CALL PUSHREAL16ARRAY(V,SIZE)\n"
"  CALL PUSHREAL16ARRAY(VD,SIZE)\n"
"END\n"
"\n"
"CALL_EXPAND POPREAL16ARRAY_B(V,VD,SIZE)\n"
"  CALL POPREAL16ARRAY(VD,SIZE)\n"
"  CALL POPREAL16ARRAY(V,SIZE)\n"
"END\n"
"\n"
"CALL_EXPAND PUSHINTEGER1_B(V,VD)\n"
"  CALL PUSHINTEGER1(V)\n"
"  CALL PUSHINTEGER1(VD)\n"
"END\n"
"\n"
"CALL_EXPAND POPINTEGER1_B(V,VD)\n"
"  CALL POPINTEGER1(VD)\n"
"  CALL POPINTEGER1(V)\n"
"END\n"
"\n"
"CALL_EXPAND LOOKINTEGER1_B(V,VD)\n"
"  CONTINUE\n"
"END\n"
"\n"
"CALL_EXPAND PUSHINTEGER1ARRAY_B(V,VD,SIZE)\n"
"  CALL PUSHINTEGER1ARRAY(V,SIZE)\n"
"  CALL PUSHINTEGER1ARRAY(VD,SIZE)\n"
"END\n"
"\n"
"CALL_EXPAND POPINTEGER1ARRAY_B(V,VD,SIZE)\n"
"  CALL POPINTEGER1ARRAY(VD,SIZE)\n"
"  CALL POPINTEGER1ARRAY(V,SIZE)\n"
"END\n"
"\n"
"CALL_EXPAND PUSHINTEGER2_B(V,VD)\n"
"  CALL PUSHINTEGER2(V)\n"
"  CALL PUSHINTEGER2(VD)\n"
"END\n"
"\n"
"CALL_EXPAND POPINTEGER2_B(V,VD)\n"
"  CALL POPINTEGER2(VD)\n"
"  CALL POPINTEGER2(V)\n"
"END\n"
"\n"
"CALL_EXPAND LOOKINTEGER2_B(V,VD)\n"
"  CONTINUE\n"
"END\n"
"\n"
"CALL_EXPAND PUSHINTEGER2ARRAY_B(V,VD,SIZE)\n"
"  CALL PUSHINTEGER2ARRAY(V,SIZE)\n"
"  CALL PUSHINTEGER2ARRAY(VD,SIZE)\n"
"END\n"
"\n"
"CALL_EXPAND POPINTEGER2ARRAY_B(V,VD,SIZE)\n"
"  CALL POPINTEGER2ARRAY(VD,SIZE)\n"
"  CALL POPINTEGER2ARRAY(V,SIZE)\n"
"END\n"
"\n"
"CALL_EXPAND PUSHINTEGER4_B(V,VD)\n"
"  CALL PUSHINTEGER4(V)\n"
"  CALL PUSHINTEGER4(VD)\n"
"END\n"
"\n"
"CALL_EXPAND POPINTEGER4_B(V,VD)\n"
"  CALL POPINTEGER4(VD)\n"
"  CALL POPINTEGER4(V)\n"
"END\n"
"\n"
"CALL_EXPAND LOOKINTEGER4_B(V,VD)\n"
"  CONTINUE\n"
"END\n"
"\n"
"CALL_EXPAND PUSHINTEGER4ARRAY_B(V,VD,SIZE)\n"
"  CALL PUSHINTEGER4ARRAY(V,SIZE)\n"
"  CALL PUSHINTEGER4ARRAY(VD,SIZE)\n"
"END\n"
"\n"
"CALL_EXPAND POPINTEGER4ARRAY_B(V,VD,SIZE)\n"
"  CALL POPINTEGER4ARRAY(VD,SIZE)\n"
"  CALL POPINTEGER4ARRAY(V,SIZE)\n"
"END\n"
"\n"
"CALL_EXPAND PUSHINTEGER8_B(V,VD)\n"
"  CALL PUSHINTEGER8(V)\n"
"  CALL PUSHINTEGER8(VD)\n"
"END\n"
"\n"
"CALL_EXPAND POPINTEGER8_B(V,VD)\n"
"  CALL POPINTEGER8(VD)\n"
"  CALL POPINTEGER8(V)\n"
"END\n"
"\n"
"CALL_EXPAND LOOKINTEGER8_B(V,VD)\n"
"  CONTINUE\n"
"END\n"
"\n"
"CALL_EXPAND PUSHINTEGER8ARRAY_B(V,VD,SIZE)\n"
"  CALL PUSHINTEGER8ARRAY(V,SIZE)\n"
"  CALL PUSHINTEGER8ARRAY(VD,SIZE)\n"
"END\n"
"\n"
"CALL_EXPAND POPINTEGER8ARRAY_B(V,VD,SIZE)\n"
"  CALL POPINTEGER8ARRAY(VD,SIZE)\n"
"  CALL POPINTEGER8ARRAY(V,SIZE)\n"
"END\n"
"\n"
"CALL_EXPAND PUSHCONTROL1B_B(V,VD)\n"
"  CALL PUSHCONTROL1B(V)\n"
"  CALL PUSHCONTROL1B(VD)\n"
"END\n"
"\n"
"CALL_EXPAND POPCONTROL1B_B(V,VD)\n"
"  CALL POPCONTROL1B(VD)\n"
"  CALL POPCONTROL1B(V)\n"
"END\n"
"\n"
"CALL_EXPAND LOOKCONTROL1B_B(V,VD)\n"
"  CONTINUE\n"
"END\n"
"\n"
"CALL_EXPAND PUSHCONTROL1BARRAY_B(V,VD,SIZE)\n"
"  CALL PUSHCONTROL1BARRAY(V,SIZE)\n"
"  CALL PUSHCONTROL1BARRAY(VD,SIZE)\n"
"END\n"
"\n"
"CALL_EXPAND POPCONTROL1BARRAY_B(V,VD,SIZE)\n"
"  CALL POPCONTROL1BARRAY(VD,SIZE)\n"
"  CALL POPCONTROL1BARRAY(V,SIZE)\n"
"END\n"
"\n"
"CALL_EXPAND PUSHCONTROL2B_B(V,VD)\n"
"  CALL PUSHCONTROL2B(V)\n"
"  CALL PUSHCONTROL2B(VD)\n"
"END\n"
"\n"
"CALL_EXPAND POPCONTROL2B_B(V,VD)\n"
"  CALL POPCONTROL2B(VD)\n"
"  CALL POPCONTROL2B(V)\n"
"END\n"
"\n"
"CALL_EXPAND LOOKCONTROL2B_B(V,VD)\n"
"  CONTINUE\n"
"END\n"
"\n"
"CALL_EXPAND PUSHCONTROL2BARRAY_B(V,VD,SIZE)\n"
"  CALL PUSHCONTROL2BARRAY(V,SIZE)\n"
"  CALL PUSHCONTROL2BARRAY(VD,SIZE)\n"
"END\n"
"\n"
"CALL_EXPAND POPCONTROL2BARRAY_B(V,VD,SIZE)\n"
"  CALL POPCONTROL2BARRAY(VD,SIZE)\n"
"  CALL POPCONTROL2BARRAY(V,SIZE)\n"
"END\n"
"\n"
"CALL_EXPAND PUSHCONTROL3B_B(V,VD)\n"
"  CALL PUSHCONTROL3B(V)\n"
"  CALL PUSHCONTROL3B(VD)\n"
"END\n"
"\n"
"CALL_EXPAND POPCONTROL3B_B(V,VD)\n"
"  CALL POPCONTROL3B(VD)\n"
"  CALL POPCONTROL3B(V)\n"
"END\n"
"\n"
"CALL_EXPAND LOOKCONTROL3B_B(V,VD)\n"
"  CONTINUE\n"
"END\n"
"\n"
"CALL_EXPAND PUSHCONTROL3BARRAY_B(V,VD,SIZE)\n"
"  CALL PUSHCONTROL3BARRAY(V,SIZE)\n"
"  CALL PUSHCONTROL3BARRAY(VD,SIZE)\n"
"END\n"
"\n"
"CALL_EXPAND POPCONTROL3BARRAY_B(V,VD,SIZE)\n"
"  CALL POPCONTROL3BARRAY(VD,SIZE)\n"
"  CALL POPCONTROL3BARRAY(V,SIZE)\n"
"END\n"
"\n"
"CALL_EXPAND PUSHCONTROL4B_B(V,VD)\n"
"  CALL PUSHCONTROL4B(V)\n"
"  CALL PUSHCONTROL4B(VD)\n"
"END\n"
"\n"
"CALL_EXPAND POPCONTROL4B_B(V,VD)\n"
"  CALL POPCONTROL4B(VD)\n"
"  CALL POPCONTROL4B(V)\n"
"END\n"
"\n"
"CALL_EXPAND LOOKCONTROL4B_B(V,VD)\n"
"  CONTINUE\n"
"END\n"
"\n"
"CALL_EXPAND PUSHCONTROL4BARRAY_B(V,VD,SIZE)\n"
"  CALL PUSHCONTROL4BARRAY(V,SIZE)\n"
"  CALL PUSHCONTROL4BARRAY(VD,SIZE)\n"
"END\n"
"\n"
"CALL_EXPAND POPCONTROL4BARRAY_B(V,VD,SIZE)\n"
"  CALL POPCONTROL4BARRAY(VD,SIZE)\n"
"  CALL POPCONTROL4BARRAY(V,SIZE)\n"
"END\n"
"\n";
